    ...
    <section className="pt-16 w-full bg-white">
      ...
      >
        ...
        <div className="md:w-1/2 md:pl-8 text-center md:text-left">
          <p className="text-gray-600 text-base sm:text-lg md:text-xl">
            ...
            achieve unparalleled growth. We build to revolutionize industries
      ...
      <div
        className="w-full px-4 sm:px-6 lg:px-8 
                      ...
                      gap-6 py-6"
      >
        <img src="/turkiye-isbankasi.png" alt="İş Bankası" className="h-8" />
        <img src="/enpara.png" alt="Enpara" className="h-8" />
        <img src="/netcad.png" alt="Netcad" className="h-8" />
        <img src="/qnb.png" alt="QNB" className="h-8" />
        <img src="/fibabanka.png" alt="Fibabanka" className="h-8" />
        {/* vb. */}
      </div>
    </section>
  );
