    ...
    const values = [
        {
          title: "İnovasyon",
          description: [
            "Sürekli yenilik ve gelişim odaklı çalışma kültürü"],
          icon: "/public/collab.png",
        },
        {
          title: "Takım Ruhu",
          description: [
            "Birlikte başarma ve dayanışma kültürü"],
          icon: "/public/collab.png",
        },
        {
          title: "Şeffaflık",
          description: [
            "Açık iletişim ve karşılıklı güven"],
          icon: "/public/activeuser.png",
        },
        {
          title: "Sürdürülebilirlik",
          description: [
            "Çevreye ve topluma karşı sorumlu yaklaşım"],
          icon: "/public/activeuser.png",
        },
        {
          title: "Çeşitlilik",
          description: [
            "Farklı fikirlere ve bakış açılarına değer veren kültür"],
          icon: "/public/activeuser.png",
        },
      ];
      ...
      const faqData = [
        {
          ...
          answer: "• İnovasyon, takım ruhu, şeffaflık ve sürdürülebilirlik temel değerlerimizi oluşturur.",
          icon: "/public/checkmark.png" 
        },
        {
          question: "Şirket kültürünüzü nasıl tanımlarsınız?",
          answer: "• Yenilikçi, dinamik ve işbirlikçi bir kültür. Herkesin fikirlerini özgürce paylaşabildiği açık bir iletişim ortamı.",
          icon: "/public/checkmark.png"
        },
        {
          question: "Ekip içi iletişimi nasıl sağlıyorsunuz?",
          answer: "• Düzenli toplantılar, sosyal etkinlikler ve açık iletişim kanalları ile ekip içi bağları güçlendiriyoruz.",
          icon: "/public/checkmark.png"
        },
        {
          question: "Sosyal sorumluluk projeleriniz var mı?",
          answer: "• Evet, sürdürülebilirlik ve toplumsal fayda odaklı çeşitli projelerde yer alıyoruz.",
          icon: "/public/checkmark.png"
        },
      ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center md:pt-[20px]">
            <div>
              <p className="text-lg text-gray-700 leading-relaxed font-segouie mb-6">
                <span className="font-bold underline">Finnovation</span>'da kültürümüzün temeli, 
                yenilikçi fikirlere açık olmak ve sürekli öğrenmeyi desteklemektir. 
                Ekip olarak birbirimizi dinler, destekler ve birlikte büyürüz.
              </p>
            </div>
            <div>
              <p className="text-lg text-gray-700 leading-relaxed font-segouie mb-6">
                Her bir ekip üyemizin benzersiz yeteneklerini ve bakış açılarını değerli buluyor, 
                çeşitliliğin gücüne inanıyoruz.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-16">
          <div style={{ padding: "0px 2px 10px" }} className="relative w-full overflow-visible">
            ...
            <div className="absolute bottom-[-60px] right-4 flex space-x-4 z-10">
              <button className="custom-swiper-prev w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center
              ...
              <button className="custom-swiper-next w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center
                                shadow hover:shadow-lg hover:bg-gray-200 transform hover:scale-110 transition-all">
                <svg className="w-6 h-6 text-gray-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                     fill="none" stroke="currentColor">
