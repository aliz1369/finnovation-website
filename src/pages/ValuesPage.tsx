...
const ValuesPage: React.FC = () => {
    const values = [
        {
            title: "Yoldaşız",
            description: "Gerek ekip içinde, gerekse paydaşlarımıza bağlıyız ve tüm ekosisteme bu gözle bakarız.",
            icon: "icon1.png",
        },
        {
            title: "Dürüstüz",
            description: "Ülkemizin, ailemizin, kendimizin inanmadığı hiçbir işi yapmayız. Projelerimizin ve çalışmalarımızın takibiyle ilgili sizi anında ve net bir şekilde bilgilendiririz.",
            icon: "icon4.png",
        },
        {
            title: "Ortağız",
            description: "Sadece iş ortamında değil, istersek hayatın içinde de beraberiz. Kıymet biliriz, alma-verme dengesini önemseriz. Her birimiz üzerinde çalıştığımız her konuda şirketin temsilcisi ve iş geliştiricisidir. Herkes şirkette farklı oran ve tiplerde ortaktır. Kendi işimiz olduğu bilinci ile kişisel değil ailesel düşünürüz.",
            icon: "icon2.png",
        },
        {
            title: "Müşteri Odaklıyız",
            description: "Ülkemizin, ailemizin, kendimizin inanmadığı hiçbir işi yapmayız.",
            icon: "icon5.png",
        },
        {
            title: "Samimiyiz",
            description: "İyi niyet esaslı açık iletişim kurarız, net konuşuruz. Tek iletişim noktasından hareket etmez, birebir mümkünse yüzyüze konuşuruz.",
            icon: "icon3.png",
        },
        {
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-grow relative py-16 px-8">
                ...
                <div className="relative z-10">
                    <h1 className="text-3xl font-bold text-center text-gray-800 mb-12">Değerlerimiz</h1>
