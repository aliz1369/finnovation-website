            ...
            <main className="flex-grow relative text-gray-800 py-16 px-8">
                ...
                <div className="relative z-10 max-w-6xl mx-auto">
                    ...
                    <p className="text-center mb-12">
                        ...
                        becerilerinizi geliştirmek için tasarlanmış bir eğitim
                        platformudur. Amacımız, katılımcılarımızı en güncel bilgilerle
                        donatarak, geleceğin finans dünyasında başarılı olmalarını
                        sağlamaktır.
                    </p>
                    ...
                    <ul className="list-disc list-inside text-center mb-12">
                        ...
                        <li>
                            Güncel Müfredat: Finans teknolojileriyle ilgili sürekli güncellenen
                            eğitimler.
                        </li>
                    </ul>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        {/* Sol Sütun */}
                        <div>
                            <h3 className="text-2xl font-bold mb-3">Fintech Giriş Seviyesi</h3>
                            ...
                            <ul className="list-disc list-inside text-gray-800">
                                <li>
                                    Çevrimiçi Kurslar: Esnek zamanlı eğitim imkanı sunar.
                                </li>
                                <li>Yüz Yüze Seminerler: Canlı etkileşim fırsatı.</li>
                                <li>
                                    Atölye Çalışmaları: Pratik deneyim kazanma odaklı.
                                </li>
                            </ul>
                        </div>
