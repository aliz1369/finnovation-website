        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-800 mb-2">
              ...
              olarak inovatif, yaratıcı ve sürdürülebilir çözümler sunmaktır.
              <br />
              <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 items-center">
          ...
          <div>
            ...
            <ul className="list-disc pl-6 text-gray-800 space-y-2">
              ...
              <li>
                <strong>Müşteri Merkezli Hizmet Anlayışı:</strong> Her adımda müşterilerimizi
                odağımıza alıyor, onların ihtiyaçlarına özel çözümler geliştiriyoruz.
              </li>
              <li>
