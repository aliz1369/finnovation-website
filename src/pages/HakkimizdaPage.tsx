      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 items-center">
          <div>
            ...
            <p className="text-gray-800 mb-2 text-sm md:text-base">
              2019 yılında kurulan firmamız, yüksek kalitede, sürdürülebilir ve
              kurumlara özel nitelikli hizmetler sunma misyonuyla yola çıktı.
              Amacımız, yalnızca bir hizmet sağlayıcı değil, müşterilerimizin
              yanında bir yol arkadaşı olarak inovatif, yaratıcı ve
              ...
              tutkusunun olduğuna inanıyoruz.
              <br />
              <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-800 mb-4 text-sm md:text-base">
              Bizi ayıran özelliklerimiz, müşterilerimize sunduğumuz hizmetlerde
              kalite ve güvenin teminatıdır.
            </p>
            <ul className="list-disc pl-4 md:pl-6 text-gray-800 space-y-2 text-sm md:text-base">
              <li>
                ...
                dayanan tecrübemizle müşterilerimize güçlü bir bilgi birikimi ve
              ...
              <li>
                ...
                ve etkinlik önceliğimizdir; her zaman en iyi sonuçlara ulaşmayı
                hedefliyoruz.
              </li>
              <li>
        ...
        <div className="mt-8">
          ...
          <p className="text-gray-800 mb-2 text-sm md:text-base">
            ...
            olmak ve yoldaşımız olan iş ortaklarımıza yüksek kalitede, uygun
            fiyatlı, sürdürülebilir ve değer yaratan ürün, hizmet ve çözümler
            sunmaktır.
          </p>
        </div>
      </div>
